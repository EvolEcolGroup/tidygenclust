...
We run fastmicxture for a series of K values simultaneously. The output object is a list of Q matrices that then we can use for downstream plotting/ analyses
